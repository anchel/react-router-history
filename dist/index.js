...
exports.createQueryPath = exports.createPath = exports.parsePath = exports.getQueryStringValueFromPath = exports.stripQueryStringValueFromPath = exports.addQueryStringValueToPath = exports.__r__ = undefined;

var _warning = __webpack_require__(43);

var _warning2 = _interopRequireDefault(_warning);

var _queryString = __webpack_require__(98);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var __r__ = exports.__r__ = '__r__';
...
var createQueryPath = exports.createQueryPath = function createQueryPath(location) {
  if (location == null || typeof location === 'string') {
    return window.location.pathname + '?' + (0, _queryString.stringify)({
      __r__: location
    });
  }
  ...
  var query = (0, _queryString.parse)(searchstr.slice(1));
  ...
  uri += '?' + (0, _queryString.stringify)(query);
...
var _useRouterHistory = __webpack_require__(137);
...
var _BrowserProtocol = __webpack_require__(95);
...
var _browserHistory = __webpack_require__(133);

var _browserHistory2 = _interopRequireDefault(_browserHistory);

var _hashHistory = __webpack_require__(136);
...
var _browserQueryHistory = __webpack_require__(134);
...
var _createQueryHistory = __webpack_require__(325);
...
var _useBasename = __webpack_require__(128);
...
var _createLocation = function _createLocation(historyState) {
  var key = historyState && historyState.key;
  var query = (0, _queryString.parse)(window.location.search);
  return (0, _LocationUtils.createLocation)({
    pathname: query[_PathUtils.__r__],
    search: window.location.search,
    hash: window.location.hash,
    state: key ? (0, _DOMStateStorage.readState)(key) : undefined
  }, undefined, key);
...
var startListener = exports.startListener = function startListener(listener) {
  var handlePopState = function handlePopState(event) {
    if ((0, _DOMUtils.isExtraneousPopstateEvent)(event)) // Ignore extraneous popstate events in WebKit
      return;
    var loc = _createLocation(event.state);
    var query = (0, _queryString.parse)(window.location.search);
    if (!query[_PathUtils.__r__]) {
      replaceLocation(loc);
    } else {
      listener(loc);
    }
...
var updateLocation = function updateLocation(location, updateState) {
  ...
  updateState({ key: key }, (0, _PathUtils.createQueryPath)(location));
};
...
var _HashProtocol = __webpack_require__(321);
...
var _BrowserQueryProtocol = __webpack_require__(320);

var BrowserProtocol = _interopRequireWildcard(_BrowserQueryProtocol);
 ...
 * behavior using { forceRefresh: true } in options.
 */
var createBrowserQueryHistory = function createBrowserQueryHistory() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
exports.default = createBrowserQueryHistory;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18)))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(130), __webpack_require__(18)))
